...
Route::group(
    ...
    function () {
        ...
        if (config('backpack.base.setup_my_account_routes')) {
            Route::get('profile', 'Auth\MyAccountController@getAccountInfoForm')->name('backpack.account.profile');
            Route::post('profile', 'Auth\MyAccountController@postAccountInfoForm');
